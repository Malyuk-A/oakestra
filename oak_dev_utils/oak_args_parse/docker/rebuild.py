...
def prepare_docker_rebuild_argparser(docker_subparsers: Subparsers) -> None:
    ...
    docker_rebuild_parser = docker_subparsers.add_parser(
        "rebuild",
        aliases=["r"],
        help=HELP_TEXT,
    ...
    docker_rebuild_subparsers = docker_rebuild_parser.add_subparsers()
    prepare_docker_rebuild_root_orchestrator_service_parser(docker_rebuild_subparsers)
    prepare_docker_rebuild_cluster_orchestrator_service_parser(docker_rebuild_subparsers)
